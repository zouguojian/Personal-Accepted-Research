...
## 2024年
### MT-STNet: A Novel Multi-Task Spatiotemporal Network for Highway Traffic Flow Prediction, IEEE Transactions on Intelligent Transportation Systems, 0001-0016. (SCI, 中科院一区, IF: 9.551, <font color=#FF000>first author</font>) 
...
* code link [click](https://github.com/zouguojian/Traffic-flow-prediction/tree/main/MT-STNet)
